...
- (void)navigation:(CDVInvokedUrlCommand*)command
{
    ...
    CGFloat endLng = [[command.arguments objectAtIndex:3] doubleValue];
    CGFloat endLat = [[command.arguments objectAtIndex:4] doubleValue];
    opType = [[command.arguments objectAtIndex:6] doubleValue];
